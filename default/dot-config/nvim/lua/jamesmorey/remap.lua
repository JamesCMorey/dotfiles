...
-- when NERDTree is untoggled and retoggled it messes up the height, so it must
-- be made fixed by the following function
vim.keymap.set("n", "<leader>h", function()
	vim.cmd("belowright 12split | terminal")
	vim.cmd("startinsert")

	-- Lock this window's height so later layout changes don't resize it
...
-- 	pattern = "markdown",
-- 	callback = function()
-- 		vim.keymap.set("n", "<CR>", nav.follow_link,
